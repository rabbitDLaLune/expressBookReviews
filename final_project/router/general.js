...
// Internal route for Axios - all books
public_users.get('/internal/books', function (req, res) {
  return res.status(200).json(books);
});


// Internal route for Axios - ISBN
...
// Internal route for Axios - author
...
// Internal route for Axios - title
...
// Task 12: Get book details based on author using Axios with Promise callbacks
...
// Task 13: Get book details based on title using Axios with Promise callbacks
